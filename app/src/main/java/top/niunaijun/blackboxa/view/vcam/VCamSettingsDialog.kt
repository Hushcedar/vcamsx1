...
class VCamSettingsDialog : BottomSheetDialogFragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        btnSave.setOnClickListener {
            ...
            VCamPrefs.write(requireContext(), pkg, VCamConfig(
                method   = method,
                videoUri = tvVideoPath.text.toString().let { if (it == "No video selected") "" else it },
                netUrl   = editUrl.text.toString().trim(),
                picUri   = tvPicPath.text.toString().let { if (it == "No picture selected") "" else it },
