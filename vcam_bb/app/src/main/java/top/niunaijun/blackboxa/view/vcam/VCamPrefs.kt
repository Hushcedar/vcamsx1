...
/**
 * Per-package VCamera config storage.
 * Key format: "<packageName>_<field>"
 * BlackBox camera hook reads this at Camera2 open time via readConfig().
 */
object VCamPrefs {
    ...
    /** Returns all packages that have an active vcam config */
