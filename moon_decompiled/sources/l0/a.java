...
public final class a extends c {
    ...
    public class C0050a extends com.core.hack.handle.client.c {
        static {
            perationCompat.init0(543);
        }

        public C0050a() {
            super("android.hardware.biometrics.IAuthService");
        }
